...
?>
    ...
    <section class="food-menu">
        <div class="container text-left">
            <h2 class="text-center">Main Course Food</h2>
        <div class="text-left" id="product_list">
            <?php 

            $sql2 ="SELECT p.id, p.title, p.price, v.shop_name, p.vendor_id, p.image_name FROM product_list as p INNER JOIN vendor_list v on v.id=.p.vendor_id WHERE category='Main' OR add_category='Appetizer'";
