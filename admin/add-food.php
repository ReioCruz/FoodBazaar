    ...
    <div class="wrapper">
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                //Chech whether radio button for featured and active are checked or not
                ...
                //Fod numberical value we di not need to pass value inside quotes '' But for string value it is compulsory to add quotes ''
                ...
                //4. Redirect wtih message to manage food page
                if($res2 == true)
                {
