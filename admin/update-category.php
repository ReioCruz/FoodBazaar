    ...
    <div class="wrapper">
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['nmae']))
                {
                    //Getthe image details
                    ...
                    if($image_name !="")
                    {
                        ...
                        if($current_image!="")
                        {
                            ...
                            //If failedto remove then display message and stop the process
                            if($remove==false)
                            {
                                //Failed to remove image
                                $_SESSION['failed-remove'] = "<div class='error'> Failed to remove current Image.</div>";
                                header('location:'.SITREURL.'admin/manage-category.php');
